				...
				<table>
					<tr>
						...
						<td><input type="text" id="id" name="id" placeholder="아이디"
							required="required"> <input type="checkbox" id="admin"
							name="admin" value="0"> <label for="admin">admin</label>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th colspan="2"><input type="button" value="로그인"
							id="submitBtn" class="btn" style="width: 48%;"> <input
							type="reset" value="취소" id="resetBtn" class="btn"
							style="width: 48%;"> <br>
